...
export function swatchStyle(c:ColorDef):React.CSSProperties{
  ...
  return{background:c.hex,...(c.shimmer?{backgroundImage:'linear-gradient(135deg,rgba(255,255,255,.65) 0%,rgba(255,255,255,.0) 45%,rgba(255,255,255,.45) 100%)'}:{}),border:light?'1px solid var(--border)':'none'};
}

    ...
    <div style={{position:'fixed',inset:0,zIndex:100,overflowY:'auto',display:'flex',flexDirection:'column',background:'var(--ivory)'}}
      ...
      <div style={{position:'relative',background:'var(--ivory2)',flexShrink:0}}>
        ...
        <div style={{position:'absolute',top:0,left:0,right:0,padding:'12px 14px',display:'flex',justifyContent:'space-between',background:'linear-gradient(to bottom,rgba(249,247,242,.88),transparent)'}}>
          <button onClick={onClose} style={{width:36,height:36,display:'flex',alignItems:'center',justifyContent:'center',borderRadius:10,background:'rgba(249,247,242,.88)',border:'1px solid var(--border2)',boxShadow:'0 1px 4px rgba(160,135,106,.15)',cursor:'pointer',color:'var(--brown)'}}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" style={{width:18,height:18}}><polyline points="15 18 9 12 15 6"/></svg>
          </button>
          <div style={{position:'relative',display:'flex',gap:8}}>
            <button onClick={()=>onEdit(item)} style={{width:36,height:36,display:'flex',alignItems:'center',justifyContent:'center',borderRadius:10,background:'rgba(249,247,242,.88)',border:'1px solid var(--border2)',boxShadow:'0 1px 4px rgba(160,135,106,.15)',cursor:'pointer',color:'var(--brown)'}}>
            ...
            <button onClick={()=>setMenuOpen(p=>!p)} style={{width:36,height:36,display:'flex',alignItems:'center',justifyContent:'center',borderRadius:10,background:'rgba(249,247,242,.88)',border:'1px solid var(--border2)',boxShadow:'0 1px 4px rgba(160,135,106,.15)',cursor:'pointer',color:'var(--t2)'}}>

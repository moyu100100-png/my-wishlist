...
import{store,Theme,ColorDef}from'@/lib/store';
...
export default function SettingsSheet({open,onClose,onUpdate}:Props){
  ...
  const PlaceholderSec=({label,icon}:{label:string,icon:React.ReactNode})=>(
  ...
  return(
    ...
    <Sheet open={open} onClose={onClose} title="My Wish List">
      <div style={{paddingBottom:40}}>
        ...
        {/* Placeholders */}
        <PlaceholderSec label="プレミアム機能" icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" style={{width:18,height:18}}><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>}/>
        <PlaceholderSec label="コーヒーを差し入れる" icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" style={{width:18,height:18}}><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg>}/>
        <PlaceholderSec label="バックアップ / 復元" icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" style={{width:18,height:18}}><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-.08-4.43"/></svg>}/>
